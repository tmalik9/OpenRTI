...
public:
  ...
  std::unique_ptr<rti1516e::LogicalTimeFactory> _logicalTimeFactory;
  std::unique_ptr<rti1516e::LogicalTimeInterval> _zeroTimeInterval;
  std::unique_ptr<rti1516e::LogicalTimeInterval> _epsilonTimeInterval;
};

class OPENRTI_LOCAL RTI1516ELogicalTimeFactory::LogicalTimeIntervalImplementation : public Referenced {
public:
  LogicalTimeIntervalImplementation(std::unique_ptr<rti1516e::LogicalTimeInterval> logicalTimeInterval,
  ...
  std::unique_ptr<rti1516e::LogicalTimeInterval> _logicalTimeInterval;
...
public:
  LogicalTimeImplementation(std::unique_ptr<rti1516e::LogicalTime> logicalTime,
                            const LogicalTimeFactoryImplementation* logicalTimeFactory) :
  ...
  std::unique_ptr<rti1516e::LogicalTime> _logicalTime;
  SharedPtr<const LogicalTimeFactoryImplementation> _logicalTimeFactory;
};
...
RTI1516ELogicalTimeFactory::LogicalTimeFactoryImplementation::LogicalTimeFactoryImplementation(std::unique_ptr<rti1516e::LogicalTimeFactory> factory) :
...
RTI1516ELogicalTimeFactory::LogicalTimeFactoryImplementation::initialLogicalTime() const
{
  if (!_logicalTimeFactory.get())
    return 0;
  std::unique_ptr<rti1516e::LogicalTime> logicalTime = _logicalTimeFactory->makeInitial();
...
RTI1516ELogicalTimeFactory::LogicalTimeFactoryImplementation::finalLogicalTime() const
{
  if (!_logicalTimeFactory.get())
    return 0;
  std::unique_ptr<rti1516e::LogicalTime> logicalTime = _logicalTimeFactory->makeFinal();
  return new LogicalTimeImplementation(std::move(logicalTime), this);
}
...
RTI1516ELogicalTimeFactory::LogicalTimeFactoryImplementation::zeroLogicalTimeInterval() const
{
  if (!_logicalTimeFactory.get())
    return 0;
  std::unique_ptr<rti1516e::LogicalTimeInterval> logicalTimeInterval = _logicalTimeFactory->makeZero();
...
RTI1516ELogicalTimeFactory::RTI1516ELogicalTimeFactory(std::unique_ptr<rti1516e::LogicalTimeFactory> logicalTimeFactory) :
...
RTI1516ELogicalTimeFactory::getLogicalTime(const rti1516e::LogicalTime& rti1516LogicalTime)
{
  ...
  if (!_implementation->_logicalTimeFactory.get())
    return LogicalTime();
  std::unique_ptr<rti1516e::LogicalTime> logicalTime = _implementation->_logicalTimeFactory->makeInitial();
  if (!logicalTime.get())
    return LogicalTime();
...
RTI1516ELogicalTimeFactory::getLogicalTimeInterval(const rti1516e::LogicalTimeInterval& rti1516LogicalTimeInterval)
{
  ...
  if (!_implementation->_logicalTimeFactory.get())
    return LogicalTimeInterval();
  std::unique_ptr<rti1516e::LogicalTimeInterval> logicalTimeInterval = _implementation->_logicalTimeFactory->makeZero();
  if (!logicalTimeInterval.get())
    return 0;
