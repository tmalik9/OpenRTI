...
public:
  LogicalTimeFactoryImplementation(std::unique_ptr<rti1516::LogicalTimeFactory> logicalTimeFactory);
  ...
  std::unique_ptr<rti1516::LogicalTimeInterval> _zeroTimeInterval;
  std::unique_ptr<rti1516::LogicalTimeInterval> _epsilonTimeInterval;
};

class OPENRTI_LOCAL RTI1516LogicalTimeFactory::LogicalTimeIntervalImplementation : public Referenced {
public:
  LogicalTimeIntervalImplementation(std::unique_ptr<rti1516::LogicalTimeInterval> logicalTimeInterval,
                                    const LogicalTimeFactoryImplementation* logicalTimeFactory) :
    _logicalTimeInterval(std::move(logicalTimeInterval)),
    _logicalTimeFactory(std::move(logicalTimeFactory))
  {
  }
  ...
  std::unique_ptr<rti1516::LogicalTimeInterval> _logicalTimeInterval;
...
public:
  LogicalTimeImplementation(std::unique_ptr<rti1516::LogicalTime> logicalTime,
                            const LogicalTimeFactoryImplementation* logicalTimeFactory) :
  ...
  std::unique_ptr<rti1516::LogicalTime> _logicalTime;
  SharedPtr<const LogicalTimeFactoryImplementation> _logicalTimeFactory;
};
...
RTI1516LogicalTimeFactory::LogicalTimeFactoryImplementation::LogicalTimeFactoryImplementation(std::unique_ptr<rti1516::LogicalTimeFactory> factory) :
...
RTI1516LogicalTimeFactory::LogicalTimeFactoryImplementation::initialLogicalTime() const
{
  if (!_logicalTimeFactory.get())
    return 0;
  std::unique_ptr<rti1516::LogicalTime> logicalTime = _logicalTimeFactory->makeLogicalTime();
  if (!logicalTime.get())
    return 0;
...
RTI1516LogicalTimeFactory::LogicalTimeFactoryImplementation::zeroLogicalTimeInterval() const
{
  if (!_logicalTimeFactory.get())
    return 0;
  std::unique_ptr<rti1516::LogicalTimeInterval> logicalTimeInterval = _logicalTimeFactory->makeLogicalTimeInterval();
...
RTI1516LogicalTimeFactory::RTI1516LogicalTimeFactory(std::unique_ptr<rti1516::LogicalTimeFactory> logicalTimeFactory) :
...
RTI1516LogicalTimeFactory::getLogicalTime(const rti1516::LogicalTime& rti1516LogicalTime)
{
  ...
  if (!_implementation->_logicalTimeFactory.get())
    return LogicalTime();
  std::unique_ptr<rti1516::LogicalTime> logicalTime = _implementation->_logicalTimeFactory->makeLogicalTime();
  if (!logicalTime.get())
    return LogicalTime();
...
RTI1516LogicalTimeFactory::getLogicalTimeInterval(const rti1516::LogicalTimeInterval& rti1516LogicalTimeInterval)
{
  ...
  if (!_implementation->_logicalTimeFactory.get())
    return LogicalTimeInterval();
  std::unique_ptr<rti1516::LogicalTimeInterval> logicalTimeInterval = _implementation->_logicalTimeFactory->makeLogicalTimeInterval();
  if (!logicalTimeInterval.get())
    return 0;
