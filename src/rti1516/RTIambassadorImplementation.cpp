...
public:
  ...
  virtual TimeManagement<RTI1516Traits>* createTimeManagement(Federate& federate)
  {
    ...
    std::unique_ptr<rti1516::LogicalTimeFactory> logicalTimeFactory;
    ...
    if (!_forceOpaqueLogicalTime) {
      ...
      std::unique_ptr<rti1516::LogicalTimeInterval> logicalTimeInterval = logicalTimeFactory->makeLogicalTimeInterval();
      try {
    ...
    return new TemplateTimeManagement<RTI1516Traits, RTI1516LogicalTimeFactory>(RTI1516LogicalTimeFactory(std::move(logicalTimeFactory)));
  }
...
RTIambassadorImplementation::RTIambassadorImplementation(const std::vector<std::wstring>& args) :
