...
public:
  ...
  LogicalTime getLogicalTime(const rti1516ev::LogicalTime& rti1516LogicalTime)
  { _integer64Time = rti1516LogicalTime; return LogicalTime(_integer64Time.getTime()); }
  LogicalTimeInterval getLogicalTimeInterval(const rti1516ev::LogicalTimeInterval& rti1516LogicalTimeInterval)
  { _integer64Interval = rti1516LogicalTimeInterval; return LogicalTimeInterval(_integer64Interval.getInterval()); }

  const rti1516ev::LogicalTime& getLogicalTime(const LogicalTime& logicalTime)
  { _integer64Time.setTime(logicalTime); return _integer64Time; }
  const rti1516ev::LogicalTimeInterval& getLogicalTimeInterval(const LogicalTimeInterval& logicalTimeInterval)
  ...
  { return logicalTimeInterval == 0; }
  bool isZeroTimeInterval(const rti1516ev::LogicalTimeInterval& rti1516LogicalTimeInterval)
  { return rti1516LogicalTimeInterval.isZero(); }
  bool isPositiveTimeInterval(const rti1516ev::LogicalTimeInterval& rti1516LogicalTimeInterval)
  ...
  LogicalTime decodeLogicalTime(const VariableLengthData& variableLengthData) const
  {
    if (variableLengthData.size() < 8)
      throw rti1516ev::CouldNotDecode(L"Buffer size too short!");
    return LogicalTime(variableLengthData.getInt64BE(0));
  }
  VariableLengthData encodeLogicalTime(const rti1516ev::LogicalTime& logicalTime)
  {
  ...
  std::string toString(const rti1516ev::LogicalTime& logicalTime)
  { return ucsToUtf8(logicalTime.toString()); }
  std::string toString(const rti1516ev::LogicalTimeInterval& logicalTimeInterval)
  { return ucsToUtf8(logicalTimeInterval.toString()); }

private:
  std::string _name;
  rti1516ev::HLAinteger64Time _integer64Time;
  rti1516ev::HLAinteger64Interval _integer64Interval;
};
