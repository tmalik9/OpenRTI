 ...
 * @return void
 */
void TimeConstrainedFederate::runFederate(unsigned int iterations)
{
...
{
  /////////////////////////////////////////////
  /// publish all attributes of ObjectRoot.B
  /////////////////////////////////////////////
  /// before we can register instance of the object class ObjectRoot.B and
