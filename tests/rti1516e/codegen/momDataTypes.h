...
// Code automatically generated by T4 template from D:\vfs\CANoe\release\15.2\Projects_Source\OpenRTI\tests\rti1516e\codegen\\mom.xml, do not edit
...
class HLAinteractionSubscription
{
  public:
    ...
    virtual void SetHLAinteractionClass(rti1516e::HLAhandle value) = 0;
    virtual rti1516e::HLAhandle GetHLAinteractionClass() const = 0;
...
class HLAobjectClassBasedCount
{
  public:
    ...
    virtual uint32_t getVersion() const = 0;
    virtual void SetHLAobjectClass(rti1516e::HLAhandle value) = 0;
    virtual rti1516e::HLAhandle GetHLAobjectClass() const = 0;
...
class HLAsynchPointFederate
{
  public:
    ...
    virtual uint32_t getVersion() const = 0;
    virtual void SetHLAfederate(rti1516e::HLAhandle value) = 0;
    virtual rti1516e::HLAhandle GetHLAfederate() const = 0;
