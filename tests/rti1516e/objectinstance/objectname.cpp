...
public:
  ...
  virtual bool execJoined(rti1516e::RTIambassador& ambassador) override
  {
    ...
    rti1516e::ObjectClassHandle objectClassHandle1;
    try {
    ...
    std::set<rti1516e::AttributeHandle> attributeHandles;
    ...
    for (NameReservationMap::iterator i = _nameReservationMap.begin(); i != _nameReservationMap.end(); ++i) {
      ...
      } catch (const rti1516e::ObjectInstanceNameNotReserved&) {
    ...
    std::set<rti1516e::ObjectInstanceHandle> objectInstanceHandles;
    try {
    ...
    try {
      for (std::set<rti1516e::ObjectInstanceHandle>::iterator i = objectInstanceHandles.begin();
