...
main(int argc, char* argv[])
{
  ...
  std::unique_ptr<rti1516::LogicalTimeFactory> factory;
  ...
  std::unique_ptr<rti1516::LogicalTimeInterval> logicalTimeInterval = factory->makeLogicalTimeInterval();
  ...
  std::unique_ptr<rti1516::LogicalTime> logicalTime = factory->makeLogicalTime();
  if (!logicalTime.get()) {
  ...
  std::unique_ptr<rti1516::LogicalTime> initialTime = factory->makeLogicalTime();
  if (!initialTime.get()) {
    std::cerr << "Can not create logical time: \"" << implementationName << "\"!" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  std::unique_ptr<rti1516::LogicalTime> finalTime = factory->makeLogicalTime();
  if (!finalTime.get()) {
    std::cerr << "Can not create logical time: \"" << implementationName << "\"!" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  std::unique_ptr<rti1516::LogicalTime> logicalTime2 = factory->makeLogicalTime();
  if (!logicalTime2.get()) {
    std::cerr << "Can not create logical time: \"" << implementationName << "\"!" << std::endl;
    return EXIT_FAILURE;
  }
  std::unique_ptr<rti1516::LogicalTimeInterval> logicalTimeInterval2 = factory->makeLogicalTimeInterval();
