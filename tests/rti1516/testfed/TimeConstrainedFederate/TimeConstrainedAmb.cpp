 ...
 */
TimeConstrainedFedAmb::TimeConstrainedFedAmb(rti1516::RTIambassador* rtiamb)
{
...
TimeConstrainedFedAmb::~TimeConstrainedFedAmb()
throw()
{
}
 ...
 */
double TimeConstrainedFedAmb::convertTime(LogicalTime const& theTime)
{
...
///////////////////////////////////////////////////////////////////////////////
void TimeConstrainedFedAmb::synchronizationPointRegistrationSucceeded(std::wstring const& label)
{
  wcout << L"Successfully registered sync point: " << label << endl;
}

void TimeConstrainedFedAmb::synchronizationPointRegistrationFailed(std::wstring const& label,  SynchronizationFailureReason reason)
{
  wcout << L"Failed to register sync point: " << label << endl;
}

void TimeConstrainedFedAmb::announceSynchronizationPoint(std::wstring const& label, VariableLengthData const& theUserSuppliedTag)
{
...
void TimeConstrainedFedAmb::federationSynchronized(std::wstring const& label)
{
...
//////////////////////////////// Time Callbacks ///////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void TimeConstrainedFedAmb::timeRegulationEnabled(LogicalTime const& theFederateTime)
{
  this->isRegulating = true;
  this->federateTime = convertTime(theFederateTime);
}

void TimeConstrainedFedAmb::timeConstrainedEnabled(LogicalTime const& theFederateTime)
{
  this->isConstrained = true;
  this->federateTime = convertTime(theFederateTime);
}

void TimeConstrainedFedAmb::timeAdvanceGrant(LogicalTime const& theTime)
{
  this->isAdvancing = false;
...
//                         //
void TimeConstrainedFedAmb::discoverObjectInstance(ObjectInstanceHandle theObject,
...
void TimeConstrainedFedAmb::attributesInScope(ObjectInstanceHandle theObject,
...
void TimeConstrainedFedAmb::attributesOutOfScope(ObjectInstanceHandle theObject,
  const AttributeHandleSet& theAttributeValues)
{
  ObjectClassHandle theObjectClass = rtiamb->getKnownObjectClassHandle(theObject);
  wcout << __FUNCTIONW__ << L": "
...
//                                 //
void TimeConstrainedFedAmb::reflectAttributeValues(ObjectInstanceHandle theObject,
...
void TimeConstrainedFedAmb::provideAttributeValueUpdate(ObjectInstanceHandle theObject, AttributeHandleSet const& theAttributes,
  VariableLengthData const& theUserSuppliedTag)
{
  ObjectClassHandle theObjectClass = rtiamb->getKnownObjectClassHandle(theObject);
  wcout << __FUNCTIONW__ << L": "
 ...
 */
std::wstring
TimeConstrainedFedAmb::variableLengthDataToWstring(const rti1516::VariableLengthData& variableLengthData)
{
 ...
 */
void TimeConstrainedFedAmb::receiveInteraction(InteractionClassHandle theInteraction, ParameterHandleValueMap const& theParameterValues,
...
void TimeConstrainedFedAmb::receiveInteraction(InteractionClassHandle theInteraction,
...
//                       //
void TimeConstrainedFedAmb::removeObjectInstance(ObjectInstanceHandle theObject,
  VariableLengthData const& theUserSuppliedTag,
  OrderType sentOrder)
{
