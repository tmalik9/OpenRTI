...
class ISystemVariable : public IHLAobjectRoot
{
  public:
    ...
    using UpdateCallbackWithTime = std::function<void(ISystemVariable*, int64_t time, OrderType orderType)>;
...
class IValueEntity : public IHLAobjectRoot
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IValueEntity*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IDOMemberSource : public IHLAobjectRoot
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IDOMemberSource*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IDOMemberTarget : public IHLAobjectRoot
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IDOMemberTarget*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IBusManagementCan : public IBusManagement
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IBusManagementCan*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IBusManagementEthernet : public IBusManagement
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IBusManagementEthernet*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IFlexRayCluster : public IBusManagement
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IFlexRayCluster*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IBusControllerCan : public IBusController
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IBusControllerCan*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IBusControllerEthernet : public IBusController
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IBusControllerEthernet*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IFlexRayControllerStatus : public IBusController
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IFlexRayControllerStatus*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IFlexRayController : public IBusController
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IFlexRayController*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
...
class IFlexRaySendBuffer : public IHLAobjectRoot
{
  public:
    ...
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
    using UpdateCallbackWithTime = std::function<void(IFlexRaySendBuffer*, int64_t time, OrderType orderType)>;
    virtual uint32_t RegisterUpdateCallbackWithTime(UpdateCallbackWithTime callback) = 0;
    virtual void UnregisterUpdateCallbackWithTime(uint32_t callbackToken) = 0;
};
