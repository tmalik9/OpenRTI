...
// Code automatically generated by FOMCodeGen version 2.0.7.0 from RTFederate.xml, do not edit
...
// ISystemVariableObjectClass represents the HLA object class HLAobjectRoot.SystemVariable.
// Instances of ISystemVariable represent the corresponding HLA object instances.
class ISystemVariableObjectClass
{
  public:
    ...
    // Create an instance of ISystemVariable. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<ISystemVariable> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of ISystemVariable, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of ISystemVariable. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<ISystemVariable> RestoreObjectInstance(std::shared_ptr<ISystemVariable> existingObject) = 0;
    // Restore a 'dead' instance of ISystemVariable, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<ISystemVariable> RestoreObjectInstance(std::shared_ptr<ISystemVariable> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class ISystemVariable : public IHLAobjectRoot
{
  public:
    ...
    // request all attribute values
    virtual void RequestAllAttributeValues() = 0;
    using UpdateCallback = std::function<void(std::shared_ptr<ISystemVariable>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IValueEntity;
// IValueEntityObjectClass represents the HLA object class HLAobjectRoot.ValueEntity.
// Instances of IValueEntity represent the corresponding HLA object instances.
class IValueEntityObjectClass
{
  public:
    ...
    // Create an instance of IValueEntity. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IValueEntity> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IValueEntity, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IValueEntity. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IValueEntity> RestoreObjectInstance(std::shared_ptr<IValueEntity> existingObject) = 0;
    // Restore a 'dead' instance of IValueEntity, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IValueEntity> RestoreObjectInstance(std::shared_ptr<IValueEntity> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IValueEntity : public IHLAobjectRoot
{
  public:
    ...
    // request all attribute values
    virtual void RequestAllAttributeValues() = 0;
    using UpdateCallback = std::function<void(std::shared_ptr<IValueEntity>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IDOMemberSource;
// IDOMemberSourceObjectClass represents the HLA object class HLAobjectRoot.DOMemberSource.
// Instances of IDOMemberSource represent the corresponding HLA object instances.
class IDOMemberSourceObjectClass
{
  public:
    ...
    // Create an instance of IDOMemberSource. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IDOMemberSource> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IDOMemberSource, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IDOMemberSource. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IDOMemberSource> RestoreObjectInstance(std::shared_ptr<IDOMemberSource> existingObject) = 0;
    // Restore a 'dead' instance of IDOMemberSource, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IDOMemberSource> RestoreObjectInstance(std::shared_ptr<IDOMemberSource> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IDOMemberSource : public IHLAobjectRoot
{
  public:
    ...
    // request all attribute values
    virtual void RequestAllAttributeValues() = 0;
    using UpdateCallback = std::function<void(std::shared_ptr<IDOMemberSource>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IDOMemberTarget;
// IDOMemberTargetObjectClass represents the HLA object class HLAobjectRoot.DOMemberTarget.
// Instances of IDOMemberTarget represent the corresponding HLA object instances.
class IDOMemberTargetObjectClass
{
  public:
    ...
    // Create an instance of IDOMemberTarget. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IDOMemberTarget> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IDOMemberTarget, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IDOMemberTarget. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IDOMemberTarget> RestoreObjectInstance(std::shared_ptr<IDOMemberTarget> existingObject) = 0;
    // Restore a 'dead' instance of IDOMemberTarget, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IDOMemberTarget> RestoreObjectInstance(std::shared_ptr<IDOMemberTarget> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IDOMemberTarget : public IHLAobjectRoot
{
  public:
    ...
    // request all attribute values
    virtual void RequestAllAttributeValues() = 0;
    using UpdateCallback = std::function<void(std::shared_ptr<IDOMemberTarget>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IBusManagement;
// IBusManagementObjectClass represents the HLA object class HLAobjectRoot.BusManagement.
// Instances of IBusManagement represent the corresponding HLA object instances.
class IBusManagementObjectClass
{
  public:
    ...
    // Create an instance of IBusManagement. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusManagement> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IBusManagement, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IBusManagement. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusManagement> RestoreObjectInstance(std::shared_ptr<IBusManagement> existingObject) = 0;
    // Restore a 'dead' instance of IBusManagement, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IBusManagement> RestoreObjectInstance(std::shared_ptr<IBusManagement> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
// IBusManagementCanObjectClass represents the HLA object class HLAobjectRoot.BusManagement.BusManagementCan.
// Instances of IBusManagementCan represent the corresponding HLA object instances.
class IBusManagementCanObjectClass
{
  public:
    ...
    // Create an instance of IBusManagementCan. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusManagementCan> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IBusManagementCan, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IBusManagementCan. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusManagementCan> RestoreObjectInstance(std::shared_ptr<IBusManagementCan> existingObject) = 0;
    // Restore a 'dead' instance of IBusManagementCan, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IBusManagementCan> RestoreObjectInstance(std::shared_ptr<IBusManagementCan> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IBusManagementCan : public IBusManagement
{
  public:
    ...
    using UpdateCallback = std::function<void(std::shared_ptr<IBusManagementCan>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IBusManagementEthernet;
// IBusManagementEthernetObjectClass represents the HLA object class HLAobjectRoot.BusManagement.BusManagementEthernet.
// Instances of IBusManagementEthernet represent the corresponding HLA object instances.
class IBusManagementEthernetObjectClass
{
  public:
    ...
    // Create an instance of IBusManagementEthernet. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusManagementEthernet> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IBusManagementEthernet, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IBusManagementEthernet. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusManagementEthernet> RestoreObjectInstance(std::shared_ptr<IBusManagementEthernet> existingObject) = 0;
    // Restore a 'dead' instance of IBusManagementEthernet, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IBusManagementEthernet> RestoreObjectInstance(std::shared_ptr<IBusManagementEthernet> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IBusManagementEthernet : public IBusManagement
{
  public:
    ...
    virtual bool GetSendMessagesAsRx() const = 0;
    virtual void SetSendMessagesAsRx(bool newValue) = 0;
    using UpdateCallback = std::function<void(std::shared_ptr<IBusManagementEthernet>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IFlexRayCluster;
// IFlexRayClusterObjectClass represents the HLA object class HLAobjectRoot.BusManagement.FlexRayCluster.
// Instances of IFlexRayCluster represent the corresponding HLA object instances.
class IFlexRayClusterObjectClass
{
  public:
    ...
    // Create an instance of IFlexRayCluster. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRayCluster> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IFlexRayCluster, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IFlexRayCluster. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRayCluster> RestoreObjectInstance(std::shared_ptr<IFlexRayCluster> existingObject) = 0;
    // Restore a 'dead' instance of IFlexRayCluster, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IFlexRayCluster> RestoreObjectInstance(std::shared_ptr<IFlexRayCluster> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IFlexRayCluster : public IBusManagement
{
  public:
    ...
    using UpdateCallback = std::function<void(std::shared_ptr<IFlexRayCluster>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IBusController;
// IBusControllerObjectClass represents the HLA object class HLAobjectRoot.BusController.
// Instances of IBusController represent the corresponding HLA object instances.
class IBusControllerObjectClass
{
  public:
    ...
    // Create an instance of IBusController. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusController> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IBusController, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IBusController. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusController> RestoreObjectInstance(std::shared_ptr<IBusController> existingObject) = 0;
    // Restore a 'dead' instance of IBusController, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IBusController> RestoreObjectInstance(std::shared_ptr<IBusController> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
// IBusControllerCanObjectClass represents the HLA object class HLAobjectRoot.BusController.BusControllerCan.
// Instances of IBusControllerCan represent the corresponding HLA object instances.
class IBusControllerCanObjectClass
{
  public:
    ...
    // Create an instance of IBusControllerCan. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusControllerCan> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IBusControllerCan, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IBusControllerCan. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusControllerCan> RestoreObjectInstance(std::shared_ptr<IBusControllerCan> existingObject) = 0;
    // Restore a 'dead' instance of IBusControllerCan, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IBusControllerCan> RestoreObjectInstance(std::shared_ptr<IBusControllerCan> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IBusControllerCan : public IBusController
{
  public:
    ...
    using UpdateCallback = std::function<void(std::shared_ptr<IBusControllerCan>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IBusControllerEthernet;
// IBusControllerEthernetObjectClass represents the HLA object class HLAobjectRoot.BusController.BusControllerEthernet.
// Instances of IBusControllerEthernet represent the corresponding HLA object instances.
class IBusControllerEthernetObjectClass
{
  public:
    ...
    // Create an instance of IBusControllerEthernet. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusControllerEthernet> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IBusControllerEthernet, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IBusControllerEthernet. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IBusControllerEthernet> RestoreObjectInstance(std::shared_ptr<IBusControllerEthernet> existingObject) = 0;
    // Restore a 'dead' instance of IBusControllerEthernet, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IBusControllerEthernet> RestoreObjectInstance(std::shared_ptr<IBusControllerEthernet> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IBusControllerEthernet : public IBusController
{
  public:
    ...
    virtual std::string GetPortName() const = 0;
    virtual void SetPortName(std::string newValue) = 0;
    using UpdateCallback = std::function<void(std::shared_ptr<IBusControllerEthernet>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IFlexRayControllerStatus;
// IFlexRayControllerStatusObjectClass represents the HLA object class HLAobjectRoot.BusController.FlexRayControllerStatus.
// Instances of IFlexRayControllerStatus represent the corresponding HLA object instances.
class IFlexRayControllerStatusObjectClass
{
  public:
    ...
    // Create an instance of IFlexRayControllerStatus. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRayControllerStatus> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IFlexRayControllerStatus, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IFlexRayControllerStatus. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRayControllerStatus> RestoreObjectInstance(std::shared_ptr<IFlexRayControllerStatus> existingObject) = 0;
    // Restore a 'dead' instance of IFlexRayControllerStatus, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IFlexRayControllerStatus> RestoreObjectInstance(std::shared_ptr<IFlexRayControllerStatus> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IFlexRayControllerStatus : public IBusController
{
  public:
    ...
    using UpdateCallback = std::function<void(std::shared_ptr<IFlexRayControllerStatus>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IFlexRayController;
// IFlexRayControllerObjectClass represents the HLA object class HLAobjectRoot.BusController.FlexRayController.
// Instances of IFlexRayController represent the corresponding HLA object instances.
class IFlexRayControllerObjectClass
{
  public:
    ...
    // Create an instance of IFlexRayController. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRayController> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IFlexRayController, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IFlexRayController. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRayController> RestoreObjectInstance(std::shared_ptr<IFlexRayController> existingObject) = 0;
    // Restore a 'dead' instance of IFlexRayController, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IFlexRayController> RestoreObjectInstance(std::shared_ptr<IFlexRayController> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IFlexRayController : public IBusController
{
  public:
    ...
    using UpdateCallback = std::function<void(std::shared_ptr<IFlexRayController>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};

class IFlexRaySendBuffer;
// IFlexRaySendBufferObjectClass represents the HLA object class HLAobjectRoot.FlexRaySendBuffer.
// Instances of IFlexRaySendBuffer represent the corresponding HLA object instances.
class IFlexRaySendBufferObjectClass
{
  public:
    ...
    // Create an instance of IFlexRaySendBuffer. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRaySendBuffer> CreateObjectInstance(const std::wstring& instanceName) = 0;
    // Create an instance of IFlexRaySendBuffer, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    ...
    // Restore a 'dead' instance of IFlexRaySendBuffer. Returns nullptr if the object instance already exists.
    // If another federate has already created an object instance with the same name and the same object class,
    // the discover object instance mechanism will reuse the object returned by 'create object instance'.
    // A discover object instance callback should be installed by the application to appropriately handle this case.
    virtual std::shared_ptr<IFlexRaySendBuffer> RestoreObjectInstance(std::shared_ptr<IFlexRaySendBuffer> existingObject) = 0;
    // Restore a 'dead' instance of IFlexRaySendBuffer, and notify the application about having completed the HLA object registration.
    // The callback's 'success' parameter indicates whether the object instance name could successfully be reserved for the object.
    virtual std::shared_ptr<IFlexRaySendBuffer> RestoreObjectInstance(std::shared_ptr<IFlexRaySendBuffer> existingObject, ObjectCreatedCallbackType createdCallback) = 0;
...
class IFlexRaySendBuffer : public IHLAobjectRoot
{
  public:
    ...
    static const AttributeBits kPayloadLengthInWordsBit = 0x400;
    ...
    // attribute PayloadLengthInWords : HLAoctet
    virtual uint8_t GetPayloadLengthInWords() const = 0;
    virtual void SetPayloadLengthInWords(uint8_t newValue) = 0;
    // send all attribute values
    virtual void UpdateAllAttributeValues() = 0;
    // send all attribute values, as TSO message
    virtual void UpdateAllAttributeValues(int64_t time) = 0;
    ...
    // request all attribute values
    virtual void RequestAllAttributeValues() = 0;
    using UpdateCallback = std::function<void(std::shared_ptr<IFlexRaySendBuffer>, optional<int64_t> time, optional<OrderType> orderType)>;
    virtual uint32_t RegisterUpdateCallback(UpdateCallback callback) = 0;
    virtual void UnregisterUpdateCallback(uint32_t callbackToken) = 0;
};
