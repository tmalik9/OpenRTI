...
class BusMessageInteractionClass : public IBusMessageInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class EthPacketInteractionClass : public IEthPacketInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<const EthernetPacket&> Frame, optional<std::string> PortName, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class EthPacketErrorInteractionClass : public IEthPacketErrorInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<const EthernetPacketError&> Frame, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class EthPacketErrorForwardedInteractionClass : public IEthPacketErrorForwardedInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<const EthernetPacketErrorForwarded&> Frame, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class EthForwardedPacketInteractionClass : public IEthForwardedPacketInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<const EthernetPacketForwarded&> Frame, optional<std::string> PortName, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class EthStatusInteractionClass : public IEthStatusInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<const EthernetStatus&> Frame, optional<std::string> PortName, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class CANMessageInteractionClass : public ICANMessageInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<int32_t> Id, optional<const CANFrame&> Frame, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class CANErrorFrameInteractionClass : public ICANErrorFrameInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<const std::vector<uint8_t>&> Frame, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class FlexRaySymbolInteractionClass : public IFlexRaySymbolInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<FlexRaySymbolPattern> SymbolPattern, optional<FlexRayChannel> FlexRayChannel, bool deliverToSelf) override;
    void Unsubscribe() override;
...
class FlexRayCycleStartInteractionClass : public IFlexRayCycleStartInteractionClass
{
  public:
    ...
    void Unpublish() override;
    void Subscribe(bool deliverToSelf) override;
    virtual void Subscribe(optional<bool> IsRequest, optional<std::string> ChannelName, optional<BusType> BusType, optional<IBusController*> RequestingFederate, optional<IBusController*> Sender, optional<IBusController*> Receiver, optional<uint8_t> Cycle, bool deliverToSelf) override;
    void Unsubscribe() override;
