...
void SystemVariable::ReflectAttributeValues(const rti1516ev::AttributeHandleValueMap& attributes,
                                                   const rti1516ev::LogicalTime& theTime,
                                                   OrderType orderType)
{
  for (auto& attributeHandleValue : attributes)
  {
...
void SystemVariable::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(this, static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void ObjectClassRegistry::ReflectAttributeValues(rti1516ev::ObjectInstanceHandle theObject, const rti1516ev::AttributeHandleValueMap & attributes, const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  ...
  if (mSystemVariableObjectClass != nullptr && theObjectClass == mSystemVariableObjectClass->GetObjectClassHandle())
  {
    static_cast<SystemVariable*>(mSystemVariableObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mValueEntityObjectClass != nullptr && theObjectClass == mValueEntityObjectClass->GetObjectClassHandle())
  {
    static_cast<ValueEntity*>(mValueEntityObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mDOMemberSourceObjectClass != nullptr && theObjectClass == mDOMemberSourceObjectClass->GetObjectClassHandle())
  {
    static_cast<DOMemberSource*>(mDOMemberSourceObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mDOMemberTargetObjectClass != nullptr && theObjectClass == mDOMemberTargetObjectClass->GetObjectClassHandle())
  {
    static_cast<DOMemberTarget*>(mDOMemberTargetObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mBusManagementObjectClass != nullptr && theObjectClass == mBusManagementObjectClass->GetObjectClassHandle())
  {
    static_cast<BusManagement*>(mBusManagementObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mBusManagementCanObjectClass != nullptr && theObjectClass == mBusManagementCanObjectClass->GetObjectClassHandle())
  {
    static_cast<BusManagementCan*>(mBusManagementCanObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mBusManagementEthernetObjectClass != nullptr && theObjectClass == mBusManagementEthernetObjectClass->GetObjectClassHandle())
  {
    static_cast<BusManagementEthernet*>(mBusManagementEthernetObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mFlexRayClusterObjectClass != nullptr && theObjectClass == mFlexRayClusterObjectClass->GetObjectClassHandle())
  {
    static_cast<FlexRayCluster*>(mFlexRayClusterObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mBusControllerObjectClass != nullptr && theObjectClass == mBusControllerObjectClass->GetObjectClassHandle())
  {
    static_cast<BusController*>(mBusControllerObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mBusControllerCanObjectClass != nullptr && theObjectClass == mBusControllerCanObjectClass->GetObjectClassHandle())
  {
    static_cast<BusControllerCan*>(mBusControllerCanObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mBusControllerEthernetObjectClass != nullptr && theObjectClass == mBusControllerEthernetObjectClass->GetObjectClassHandle())
  {
    static_cast<BusControllerEthernet*>(mBusControllerEthernetObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mFlexRayControllerStatusObjectClass != nullptr && theObjectClass == mFlexRayControllerStatusObjectClass->GetObjectClassHandle())
  {
    static_cast<FlexRayControllerStatus*>(mFlexRayControllerStatusObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mFlexRayControllerObjectClass != nullptr && theObjectClass == mFlexRayControllerObjectClass->GetObjectClassHandle())
  {
    static_cast<FlexRayController*>(mFlexRayControllerObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
  else if (mFlexRaySendBufferObjectClass != nullptr && theObjectClass == mFlexRaySendBufferObjectClass->GetObjectClassHandle())
  {
    static_cast<FlexRaySendBuffer*>(mFlexRaySendBufferObjectClass->GetObjectInstance(theObject))->ReflectAttributeValues(attributes, theTime, orderType);
  }
}
