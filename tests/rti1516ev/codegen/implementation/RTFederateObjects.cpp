...
void SystemVariable::ReflectAttributeValues(const rti1516ev::AttributeHandleValueMap& attributes, const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  ...
  mValuesReceived |= mLastUpdated;
  ExecuteUpdateCallbacks(theTime, orderType);
  mLastUpdated = kNone;
} // SystemVariable::ReflectAttributeValues
...
void SystemVariable::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<ISystemVariable>(shared_from_this()));
  }
}

void SystemVariable::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<ISystemVariable>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void ValueEntity::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IValueEntity>(shared_from_this()));
  }
}

void ValueEntity::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IValueEntity>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void DOMemberSource::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IDOMemberSource>(shared_from_this()));
  }
}

void DOMemberSource::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IDOMemberSource>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void DOMemberTarget::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IDOMemberTarget>(shared_from_this()));
  }
}

void DOMemberTarget::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IDOMemberTarget>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void BusManagementCan::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusManagementCan>(shared_from_this()));
  }
}

void BusManagementCan::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusManagementCan>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void BusManagementEthernet::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusManagementEthernet>(shared_from_this()));
  }
}

void BusManagementEthernet::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusManagementEthernet>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void FlexRayCluster::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRayCluster>(shared_from_this()));
  }
}

void FlexRayCluster::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRayCluster>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void BusControllerCan::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusControllerCan>(shared_from_this()));
  }
}

void BusControllerCan::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusControllerCan>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void BusControllerEthernet::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusControllerEthernet>(shared_from_this()));
  }
}

void BusControllerEthernet::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IBusControllerEthernet>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void FlexRayControllerStatus::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRayControllerStatus>(shared_from_this()));
  }
}

void FlexRayControllerStatus::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRayControllerStatus>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void FlexRayController::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRayController>(shared_from_this()));
  }
}

void FlexRayController::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRayController>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
...
void FlexRaySendBuffer::ExecuteUpdateCallbacks()
{
  ...
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRaySendBuffer>(shared_from_this()));
  }
}

void FlexRaySendBuffer::ExecuteUpdateCallbacks(const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  for (auto& callbackEntry : mUpdateCallbacksWithTime)
  {
    auto& callback = callbackEntry.second;
    callback(std::static_pointer_cast<IFlexRaySendBuffer>(shared_from_this()), static_cast<const rti1516ev::HLAinteger64Time&>(theTime).getTime(), orderType);
  }
}
