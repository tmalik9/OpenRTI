...
void Participant::ReflectAttributeValues(const rti1516ev::AttributeHandleValueMap& attributes, const rti1516ev::LogicalTime& theTime, OrderType orderType)
{
  std::lock_guard<std::recursive_mutex> lock(mMutex);
  for (auto& attributeHandleValue : attributes)
  {
...
void ObjectClassRegistry::DiscoverObjectInstance(rti1516ev::ObjectInstanceHandle theObject, std::wstring const & theObjectInstanceName)
{
  ...
  else if (mParticipantObjectClass != nullptr && theObjectClass == mParticipantObjectClass->GetObjectClassHandle())
  {
    mParticipantObjectClass->DiscoverObjectInstance(theObject, theObjectInstanceName);
  }
...
void ObjectClassRegistry::RemoveObjectInstance(rti1516ev::ObjectInstanceHandle theObject)
{
  ...
  {
    mParticipantObjectClass->RemoveObjectInstance(theObject);
  }
  else if (mSystemVariableObjectClass != nullptr && theObjectClass == mSystemVariableObjectClass->GetObjectClassHandle())
  {
