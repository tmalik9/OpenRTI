...
uint32_t HLAmanagerObjectClass::RegisterDiscoverCallback(DiscoverCallbackType callback)
{
  mLastCallbackToken++;
  mDiscoverCallbacks.insert(std::make_pair(mLastCallbackToken, callback));
  return mLastCallbackToken;
...
void HLAmanagerObjectClass::UnregisterDiscoverCallback(uint32_t callbackToken)
{
  mDiscoverCallbacks.erase(callbackToken);
}

void HLAmanagerObjectClass::ExecuteDiscoverCallbacks(IHLAmanager* newObjectInstance)
{
  for (auto& callbackEntry : mDiscoverCallbacks)
  {
    auto& callback = callbackEntry.second;
...
uint32_t HLAfederateObjectClass::RegisterDiscoverCallback(DiscoverCallbackType callback)
{
  mLastCallbackToken++;
  mDiscoverCallbacks.insert(std::make_pair(mLastCallbackToken, callback));
  return mLastCallbackToken;
...
void HLAfederateObjectClass::UnregisterDiscoverCallback(uint32_t callbackToken)
{
  mDiscoverCallbacks.erase(callbackToken);
}

void HLAfederateObjectClass::ExecuteDiscoverCallbacks(IHLAfederate* newObjectInstance)
{
  for (auto& callbackEntry : mDiscoverCallbacks)
  {
    auto& callback = callbackEntry.second;
...
void HLAfederate::SetHLAfederateName(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederate::SetHLAfederateType(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederate::SetHLAfederateHost(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederate::SetHLARTIversion(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
uint32_t HLAfederationObjectClass::RegisterDiscoverCallback(DiscoverCallbackType callback)
{
  mLastCallbackToken++;
  mDiscoverCallbacks.insert(std::make_pair(mLastCallbackToken, callback));
  return mLastCallbackToken;
...
void HLAfederationObjectClass::UnregisterDiscoverCallback(uint32_t callbackToken)
{
  mDiscoverCallbacks.erase(callbackToken);
}

void HLAfederationObjectClass::ExecuteDiscoverCallbacks(IHLAfederation* newObjectInstance)
{
  for (auto& callbackEntry : mDiscoverCallbacks)
  {
    auto& callback = callbackEntry.second;
...
void HLAfederation::SetHLAfederationName(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederation::SetHLARTIversion(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
  mHLARTIversion.set(newValue);
  mDirty |= kHLARTIversionBit;
...
void HLAfederation::SetHLAMIMdesignator(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederation::SetHLAcurrentFDD(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederation::SetHLAtimeImplementationName(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederation::SetHLAlastSaveName(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
...
void HLAfederation::SetHLAnextSaveName(const std::wstring& newValue)
{
  // CanTranslateToCpp=True
