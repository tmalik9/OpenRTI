...
{
  public:
    using DiscoverCallbackType = std::function<void(IHLAmanager*)>;
    virtual void Publish() = 0;
    virtual void Unpublish() = 0;
    virtual void Subscribe() = 0;
    virtual void Unsubscribe() = 0;
...
{
  public:
    using DiscoverCallbackType = std::function<void(IHLAfederate*)>;
    virtual void Publish() = 0;
    virtual void Unpublish() = 0;
    virtual void Subscribe() = 0;
    virtual void Unsubscribe() = 0;
...
{
  public:
    using DiscoverCallbackType = std::function<void(IHLAfederation*)>;
    virtual void Publish() = 0;
    virtual void Unpublish() = 0;
    virtual void Subscribe() = 0;
    virtual void Unsubscribe() = 0;
...
class IHLAfederation : public IHLAmanager
{
  public:
    ...
    virtual void SetHLAfederationName(const std::wstring& newValue) = 0;
    ...
    virtual void SetHLAnextSaveName(const std::wstring& newValue) = 0;
