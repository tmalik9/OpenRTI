...
public:
  ...
  bool execJoined(uint32_t threadIndex) override
  {
    ...
    for (ObjectClassAttributeHandleSet::const_iterator i = _objectClassAttributeHandleSet.begin();
      ...
      rti1516ev::ObjectClassHandle subscribedObjectClass = i->first;
      ...
      for (ObjectClassAttributeHandleSet::const_iterator j = _objectClassAttributeHandleSet.begin();
        ...
        rti1516ev::ObjectClassHandle registeredObjectClass = j->first;
        ...
        if (registeredObjectClass == subscribedObjectClass) {
          ...
          _expectedObjectClassHandle = rti1516ev::ObjectClassHandle();
        ...
        _unsubscribedObjectInstanceHandle = rti1516ev::ObjectInstanceHandle();
        _resubscribedObjectInstanceHandle = rti1516ev::ObjectInstanceHandle();
  ...
  virtual void reflectAttributeValues(rti1516ev::ObjectInstanceHandle objectInstanceHandle, rti1516ev::AttributeHandleValueMap const& attributeValues,
  ...
  //void reflectAttributeValues(rti1516ev::ObjectInstanceHandle objectInstanceHandle, const rti1516ev::AttributeHandleValueMap& attributeValues,
  //  const rti1516ev::VariableLengthData&, rti1516ev::OrderType, rti1516ev::TransportationType) override
  //{
  //  _checkReflectedAttributeValues(objectInstanceHandle, attributeValues);
  //}

  //virtual void reflectAttributeValues(rti1516ev::ObjectInstanceHandle objectInstanceHandle, const rti1516ev::AttributeHandleValueMap& attributeValues,
  //                                    const rti1516ev::VariableLengthData&, rti1516ev::OrderType, rti1516ev::TransportationType,
  //                                    const rti1516ev::RegionHandleSet&)
  //{
  //  _checkReflectedAttributeValues(objectInstanceHandle, attributeValues);
  //}
  ...
  //virtual void reflectAttributeValues(rti1516ev::ObjectInstanceHandle objectInstanceHandle, const rti1516ev::AttributeHandleValueMap& attributeValues,
  //                                    const rti1516ev::VariableLengthData&, rti1516ev::OrderType, rti1516ev::TransportationType,
  //                                    const rti1516ev::LogicalTime&, rti1516ev::OrderType)
  //{
  //  _checkReflectedAttributeValues(objectInstanceHandle, attributeValues);
  //}
  ...
  void _checkReflectedAttributeValues(const rti1516ev::ObjectInstanceHandle& objectInstanceHandle, const rti1516ev::AttributeHandleValueMap& attributeValues)
  {
    ...
    for (rti1516ev::AttributeHandleValueMap::const_iterator i = attributeValues.begin();
  ...
  typedef std::map<rti1516ev::ObjectClassHandle, std::set<rti1516ev::ObjectClassHandle> > ObjectClassObjectClassHandleSet;
  ...
  rti1516ev::ObjectInstanceHandle _unsubscribedObjectInstanceHandle;
  rti1516ev::ObjectInstanceHandle _resubscribedObjectInstanceHandle;
