...
main(int argc, char* argv[])
{
  ...
  while (!addressList.empty()) {
    ...
    } catch (const rti1516ev::ConnectionFailed& e) {
      std::wcout << L"connect: rti1516ev::ConnectionFailed(" << federationExecutionName << L"): \"" << e.what() << L"\" (expected)" << std::endl;
    } catch (const rti1516ev::Exception& e) {
      std::wcout << L"connect: rti1516ev::Exception: \"" << e.what() << L"\"" << std::endl;
      return EXIT_FAILURE;
    } catch (...) {
    ...
    // Note that rti1516ev does not have a specific way to report connection failures.
    ...
    try {
      ...
      return EXIT_FAILURE;
    } catch (const rti1516ev::NotConnected& e) {
      std::wcout << L"createFederationExecution: rti1516ev::NotConnected: \"" << e.what() << L"\" (expected)" << std::endl;
    } catch (const rti1516ev::Exception& e) {
      std::wcout << L"createFederationExecution: createFederationExecution: rti1516ev::Exception: \"" << e.what() << L"\"" << std::endl;
      return EXIT_FAILURE;
    } catch (...) {
    ...
    try {
      ...
      std::wcout << L"joinFederationExecution: rti1516ev::NotConnected: \"" << e.what() << L"\" (expected)" << std::endl;
    } catch (const rti1516ev::Exception& e) {
      std::wcout << L"joinFederationExecution: rti1516ev::Exception: \"" << e.what() << L"\"" << std::endl;
      return EXIT_FAILURE;
    } catch (...) {
    ...
    try {
      ...
      std::wcout << L"resignFederationExecution: rti1516ev::NotConnected: \"" << e.what() << L"\" (expected)" << std::endl;
    } catch (const rti1516ev::Exception& e) {
      std::wcout << L"resignFederationExecution: rti1516ev::Exception: \"" << e.what() << L"\"" << std::endl;
      return EXIT_FAILURE;
    } catch (...) {
    ...
    try {
      ...
      std::wcout << L"destroyFederationExecution: rti1516ev::NotConnected: \"" << e.what() << L"\" (expected)" << std::endl;
    } catch (const rti1516ev::Exception& e) {
