...
ImmediateCallbackFederate* federate = nullptr;
...
int main(int argc, char* argv[])
{
  ...
  try {
    federate = new ImmediateCallbackFederate();
    federate->join(rtiAddress, federateName, fomPath, federationName, true, true);
