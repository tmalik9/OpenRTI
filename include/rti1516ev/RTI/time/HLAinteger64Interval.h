...
namespace rti1516ev
{
   ...
   class RTI_EXPORT HLAinteger64Interval : public rti1516ev::LogicalTimeInterval
   {
   public:
      ...
      HLAinteger64Interval (
         rti1516ev::LogicalTimeInterval const & rhs);
      ...
      rti1516ev::LogicalTimeInterval& operator= (
      ...
      rti1516ev::VariableLengthData encode () const override;
