...
namespace rti1516ev
{
   ...
   class RTI_EXPORT HLAfloat64Time : public rti1516ev::LogicalTime
   {
   public:
      // Constructors
      HLAfloat64Time ();
      ...
      HLAfloat64Time (
         rti1516ev::LogicalTime const & value);
      ...
      virtual bool operator> (
         rti1516ev::LogicalTime const & value) const override;
      ...
      virtual void decode (
         rti1516ev::VariableLengthData const & VariableLengthData) override;
