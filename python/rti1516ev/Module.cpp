...
static PyObject*
PyObject_NewVariableLengthData(const rti1516ev::VariableLengthData& variableLengthData)
{
  return PyByteArray_FromStringAndSize(static_cast<const char *>(variableLengthData.data()), variableLengthData.size());
}

static bool
PyObject_GetVariableLengthData(rti1516ev::VariableLengthData& variableLengthData, PyObject* o)
{
...
static PyObject*
PyObject_NewTransportationType(const rti1516ev::TransportationType& transportationType)
{
  return PyLong_FromLong(transportationType);
}

static bool
PyObject_GetTransportationType(rti1516ev::TransportationType& transportationType, PyObject* o)
{
  long value;
  if (PyObject_GetInt(value, o)) {
    if (value == rti1516ev::BEST_EFFORT)
      transportationType = rti1516ev::BEST_EFFORT;
    else
      transportationType = rti1516ev::RELIABLE;
...
static PyObject*
PyObject_NewOrderType(const rti1516ev::OrderType& orderType)
{
  return PyLong_FromLong(orderType);
}

static bool
PyObject_GetOrderType(rti1516ev::OrderType& orderType, PyObject* o)
{
  long value;
  if (PyObject_GetInt(value, o)) {
    if (value == rti1516ev::TIMESTAMP)
      orderType = rti1516ev::TIMESTAMP;
    else
      orderType = rti1516ev::RECEIVE;
...
static bool
PyObject_GetResignAction(rti1516ev::ResignAction& resignAction, PyObject* o)
{
  long value;
  if (PyObject_GetInt(value, o)) {
    if (value == rti1516ev::UNCONDITIONALLY_DIVEST_ATTRIBUTES)
      resignAction = rti1516ev::UNCONDITIONALLY_DIVEST_ATTRIBUTES;
    else if (value == rti1516ev::DELETE_OBJECTS)
      resignAction = rti1516ev::DELETE_OBJECTS;
    else if (value == rti1516ev::CANCEL_PENDING_OWNERSHIP_ACQUISITIONS)
      resignAction = rti1516ev::CANCEL_PENDING_OWNERSHIP_ACQUISITIONS;
    else if (value == rti1516ev::DELETE_OBJECTS_THEN_DIVEST)
      resignAction = rti1516ev::DELETE_OBJECTS_THEN_DIVEST;
    else if (value == rti1516ev::CANCEL_THEN_DELETE_THEN_DIVEST)
      resignAction = rti1516ev::CANCEL_THEN_DELETE_THEN_DIVEST;
    else if (value == rti1516ev::NO_ACTION)
      resignAction = rti1516ev::NO_ACTION;
    else
      resignAction = rti1516ev::CANCEL_THEN_DELETE_THEN_DIVEST;
    ...
    PyErr_Clear();
    if (PyObject_GetString(string, o)) {
      //rti1516ev::ResignAction resignAction;
...
static PyObject*
PyObject_NewResignAction(const rti1516ev::ResignAction& resignAction)
{
  return PyLong_FromLong(resignAction);
}

static bool
PyObject_GetServiceGroup(rti1516ev::ServiceGroup& serviceGroup, PyObject* o)
{
  long value;
  if (PyObject_GetInt(value, o)) {
    if (value == rti1516ev::FEDERATION_MANAGEMENT)
      serviceGroup = rti1516ev::FEDERATION_MANAGEMENT;
    else if (value == rti1516ev::DECLARATION_MANAGEMENT)
      serviceGroup = rti1516ev::DECLARATION_MANAGEMENT;
    else if (value == rti1516ev::OBJECT_MANAGEMENT)
      serviceGroup = rti1516ev::OBJECT_MANAGEMENT;
    else if (value == rti1516ev::OWNERSHIP_MANAGEMENT)
      serviceGroup = rti1516ev::OWNERSHIP_MANAGEMENT;
    else if (value == rti1516ev::TIME_MANAGEMENT)
      serviceGroup = rti1516ev::TIME_MANAGEMENT;
    else if (value == rti1516ev::DATA_DISTRIBUTION_MANAGEMENT)
      serviceGroup = rti1516ev::DATA_DISTRIBUTION_MANAGEMENT;
    else if (value == rti1516ev::SUPPORT_SERVICES)
      serviceGroup = rti1516ev::SUPPORT_SERVICES;
    else
      serviceGroup = rti1516ev::SUPPORT_SERVICES;
...
static PyObject*
PyObject_NewLogicalTime(const rti1516ev::LogicalTime& logicalTime)
{
  if (logicalTime.implementationName() == L"HLAfloat64Time") {
    return PyFloat_FromDouble(static_cast<const rti1516ev::HLAfloat64Time&>(logicalTime).getTime());
  } else if (logicalTime.implementationName() == L"HLAinteger64Time") {
    return PyLong_FromLongLong(static_cast<const rti1516ev::HLAinteger64Time&>(logicalTime).getTime());
  } else {
...
static bool
PyObject_GetLogicalTime(std::unique_ptr<rti1516ev::LogicalTime>& logicalTime, const std::wstring& implementationName)
{
  if (implementationName == L"HLAfloat64Time") {
    logicalTime.reset(new rti1516ev::HLAfloat64Time(0));
    return true;
  } else if (implementationName == L"HLAinteger64Time") {
    logicalTime.reset(new rti1516ev::HLAinteger64Time(0));
    return true;
  } else {
    // FIXME would be possible to model something like the abstract time factory also here in python
    return false;
...
static bool
PyObject_GetLogicalTime(std::unique_ptr<rti1516ev::LogicalTime>& logicalTime, PyObject* o, const std::wstring& implementationName)
{
  if (implementationName == L"HLAfloat64Time") {
    double value;
    if (!PyObject_GetDouble(value, o))
      return false;
    logicalTime.reset(new rti1516ev::HLAfloat64Time(value));
    return true;
  } else if (implementationName == L"HLAinteger64Time") {
    PY_LONG_LONG value;
    if (!PyObject_GetLong(value, o))
      return false;
    logicalTime.reset(new rti1516ev::HLAinteger64Time(value));
    return true;
  } else {
    // FIXME would be possible to model something like the abstract time factory also here in python
    return false;
...
static PyObject*
PyObject_NewLogicalTimeInterval(const rti1516ev::LogicalTimeInterval& logicalTimeInterval)
{
  if (logicalTimeInterval.implementationName() == L"HLAfloat64Time") {
    return PyFloat_FromDouble(static_cast<const rti1516ev::HLAfloat64Interval&>(logicalTimeInterval).getInterval());
  } else if (logicalTimeInterval.implementationName() == L"HLAinteger64Time") {
    return PyLong_FromLongLong(static_cast<const rti1516ev::HLAinteger64Interval&>(logicalTimeInterval).getInterval());
  } else {
    // FIXME would be possible to model something like the abstract time factory also here in python
    return 0;
  }
...
static bool
PyObject_GetLogicalTimeInterval(std::unique_ptr<rti1516ev::LogicalTimeInterval>& logicalTimeInterval, PyObject* o, const std::wstring& implementationName)
{
  if (implementationName == L"HLAfloat64Time") {
    double value;
    if (!PyObject_GetDouble(value, o))
      return false;
    logicalTimeInterval.reset(new rti1516ev::HLAfloat64Interval(value));
    return true;
  } else if (implementationName == L"HLAinteger64Time") {
    PY_LONG_LONG value;
    if (!PyObject_GetLong(value, o))
      return false;
    logicalTimeInterval.reset(new rti1516ev::HLAinteger64Interval(value));
    return true;
  } else {
    // FIXME would be possible to model something like the abstract time factory also here in python
    return false;
...
static bool
PyObject_GetLogicalTimeInterval(std::unique_ptr<rti1516ev::LogicalTimeInterval>& logicalTimeInterval, const std::wstring& implementationName)
{
  if (implementationName == L"HLAfloat64Time") {
    logicalTimeInterval.reset(new rti1516ev::HLAfloat64Interval(0));
    return true;
  } else if (implementationName == L"HLAinteger64Time") {
    logicalTimeInterval.reset(new rti1516ev::HLAinteger64Interval(0));
    return true;
  } else {
    // FIXME would be possible to model something like the abstract time factory also here in python
    return false;
...
static PyObject*
PyObject_NewRangeBounds(const rti1516ev::RangeBounds& rangeBounds)
{
...
static bool
PyObject_GetRangeBounds(rti1516ev::RangeBounds& rangeBounds, PyObject* o)
{
  if (!PySequence_Check(o))
    return false;
...
#define IMPLEMENT_HANDLE_CLASS(HandleKind)                              \
  ...
  struct Py ## HandleKind {                                             \
    PyObject_HEAD                                                       \
    rti1516ev::HandleKind ob_value;                                      \
  };                                                                    \
                                                                        \
  static void                                                           \
  HandleKind ## _dealloc(Py ## HandleKind *o)                           \
  {                                                                     \
    o->ob_value.rti1516ev::HandleKind::~HandleKind();                    \
    Py_TYPE(o)->tp_free(o);                                             \
  }                                                                     \
                                                                        \
  static PyObject*                                                      \
  ...
  {                                                                     \
    ...
    if (!self)                                                          \
      return 0;                                                         \
    placement_new<rti1516ev:: HandleKind>(&self->ob_value);              \
    return (PyObject*)self;                                             \
  }                                                                     \
                                                                        \
  static PyObject*                                                      \
  PyObject_New ## HandleKind(const rti1516ev:: HandleKind& handle)       \
  {                                                                     \
    Py ## HandleKind *self;                                             \
    self = PyObject_New(Py ## HandleKind, &Py ## HandleKind ## Type);   \
    if (!self)                                                          \
      return 0;                                                         \
    placement_new<rti1516ev:: HandleKind>(&self->ob_value, handle);      \
    return (PyObject*)self;                                             \
  }                                                                     \
                                                                        \
  static bool                                                           \
  PyObject_Get ## HandleKind(rti1516ev:: HandleKind& handle, PyObject* o)\
  {                                                                     \
...
#define IMPLEMENT_HANDLE_CLASS_WITH_SET(HandleKind)                     \
 IMPLEMENT_HANDLE_CLASS(HandleKind)                                     \
                                                                        \
  static PyObject*                                                      \
  PyObject_New ## HandleKind ## Set(const std::set<rti1516ev::HandleKind>& handleSet) \
  {                                                                     \
    PyObject* set = PySet_New(0);                                       \
    std::set<rti1516ev::HandleKind>::const_iterator i;                   \
    ...
    return set;                                                         \
                                                                        ...
                                                                        \
  static bool                                                           \
  PyObject_Get ## HandleKind ## Set(std::set<rti1516ev::HandleKind>& handleSet, PyObject* o) \
  {                                                                     \
    PyObject* iterator = PyObject_GetIter(o);                           \
    if (!iterator)                                                      \
      return false;                                                     \
    while (PyObject* item = PyIter_Next(iterator)) {                    \
      rti1516ev:: HandleKind handle;                                     \
...
IMPLEMENT_HANDLE_CLASS_WITH_SET(FederateHandle)
...
static PyObject*
PyObject_NewFederateHandleSaveStatusPairVector(const rti1516ev::FederationExecutionInformationVector& federationExecutionInformationVector)
{
...
static PyObject*
PyObject_NewFederateHandleSaveStatusPairVector(const rti1516ev::FederateHandleSaveStatusPairVector& federateStatusVector)
{
...
static PyObject*
PyObject_NewFederateRestoreStatusVector(const rti1516ev::FederateRestoreStatusVector& federateStatusVector)
{
  PyObject* list = PyList_New(federateStatusVector.size());
  for (size_t i = 0; i < federateStatusVector.size(); ++i) {
...
static PyObject*
PyObject_NewSupplementalReflectInfo(const rti1516ev::SupplementalReflectInfo& supplementalReflectInfo)
{
...
static PyObject*
PyObject_NewSupplementalReceiveInfo(const rti1516ev::SupplementalReceiveInfo& supplementalReceiveInfo)
{
...
static PyObject*
PyObject_NewSupplementalRemoveInfo(const rti1516ev::SupplementalRemoveInfo& supplementalRemoveInfo)
{
...
static PyObject*
PyObject_NewAttributeHandleValueMap(const rti1516ev::AttributeHandleValueMap& attributeHandleValueMap)
{
  PyObject* dict = PyDict_New();
  rti1516ev::AttributeHandleValueMap::const_iterator i;
...
static bool
PyObject_GetAttributeHandleValueMap(rti1516ev::AttributeHandleValueMap& attributeHandleValueMap, PyObject* o)
{
...
static PyObject*
PyObject_NewParameterHandleValueMap(const rti1516ev::ParameterHandleValueMap& parameterHandleValueMap)
{
  PyObject* dict = PyDict_New();
  rti1516ev::ParameterHandleValueMap::const_iterator i;
...
static bool
PyObject_GetParameterHandleValueMap(rti1516ev::ParameterHandleValueMap& parameterHandleValueMap, PyObject* o)
{
  PyObject* items = PyMapping_Items(o);
  if (!items)
    return false;
  ...
  while (PyObject* item = PyIter_Next(iterator)) {
    ...
    rti1516ev::ParameterHandle parameterHandle;
...
static bool
PyObject_GetAttributeHandleSetRegionHandleSetPairVector(rti1516ev::AttributeHandleSetRegionHandleSetPairVector& attributeHandleSetRegionHandleSetPairVector, PyObject* o)
{
  PyObject* iterator = PyObject_GetIter(o);
  if (!iterator)
    return false;
  while (PyObject* item = PyIter_Next(iterator)) {
    ...
    rti1516ev::AttributeHandleSet attributeHandleSet;
    ...
    rti1516ev::RegionHandleSet regionHandleSet;
...
#define CATCH_C_EXCEPTION(ExceptionKind)                                             \
  catch(const rti1516ev:: ExceptionKind& e) {                                          \
...
#define CATCH_PYTHON_EXCEPTION(exception)                                            \
  do {                                                                               \
    ...
    if (PyErr_GivenExceptionMatches(exception, PyExc_KeyboardInterrupt)) {           \
      ...
      PyErr_Print();                                                                 \
      throw rti1516ev::FederateInternalError(PyErr_GetExceptionString());             \
    }                                                                                \
  } while(0)

///////////////////////////////////////////////////////////////////////////////

struct PyRTI1516EFederateAmbassador : public rti1516ev::FederateAmbassador {
  ...
  void reportFederationExecutions(rti1516ev::FederationExecutionInformationVector const &federationExecutionInformationVector) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void synchronizationPointRegistrationFailed(std::wstring const & label,
                                              rti1516ev::SynchronizationPointFailureReason reason) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void federationSynchronized(std::wstring const & label, rti1516ev::FederateHandleSet const& failedToSyncSet) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void initiateFederateSave(std::wstring const & label, rti1516ev::LogicalTime const & theTime) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void federationSaveStatusResponse(rti1516ev::FederateHandleSaveStatusPairVector const & theFederateStatusVector) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void initiateFederateRestore(std::wstring const & label, std::wstring const & federateName, rti1516ev::FederateHandle handle) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void federationRestoreStatusResponse(rti1516ev::FederateRestoreStatusVector const & theFederateStatusVector) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void startRegistrationForObjectClass(rti1516ev::ObjectClassHandle theClass) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void stopRegistrationForObjectClass(rti1516ev::ObjectClassHandle theClass) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void turnInteractionsOn(rti1516ev::InteractionClassHandle theHandle) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void turnInteractionsOff(rti1516ev::InteractionClassHandle theHandle) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void discoverObjectInstance(rti1516ev::ObjectInstanceHandle theObject,
                                      rti1516ev::ObjectClassHandle theObjectClass,
  ...
  void reflectAttributeValues(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleValueMap const & theAttributeValues,
  ...
  void reflectAttributeValues(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleValueMap const & theAttributeValues,
                                      ...
                                      rti1516ev::OrderType receivedOrder, rti1516ev::MessageRetractionHandle theHandle,
                                      rti1516ev::SupplementalReflectInfo theReflectInfo) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void receiveInteraction(rti1516ev::InteractionClassHandle theInteraction, rti1516ev::ParameterHandleValueMap const & theParameterValues,
                                  rti1516ev::VariableLengthData const & theUserSuppliedTag, rti1516ev::OrderType sentOrder,
                                  rti1516ev::TransportationType theType, rti1516ev::SupplementalReceiveInfo theReceiveInfo) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void
  receiveInteraction(rti1516ev::InteractionClassHandle theInteraction, rti1516ev::ParameterHandleValueMap const & theParameterValues,
                     rti1516ev::VariableLengthData const & theUserSuppliedTag, rti1516ev::OrderType sentOrder,
                     rti1516ev::TransportationType theType, rti1516ev::LogicalTime const & theTime,
                     rti1516ev::OrderType receivedOrder, rti1516ev::MessageRetractionHandle theHandle,
                     rti1516ev::SupplementalReceiveInfo theReceiveInfo) override
  ...
  // 6.11
  void
  removeObjectInstance(rti1516ev::ObjectInstanceHandle theObject,
  ...
  removeObjectInstance(rti1516ev::ObjectInstanceHandle theObject,
                       ...
                       rti1516ev::OrderType receivedOrder, rti1516ev::SupplementalRemoveInfo theRemoveInfo) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  removeObjectInstance(rti1516ev::ObjectInstanceHandle theObject,
                       ...
                       rti1516ev::MessageRetractionHandle theHandle, rti1516ev::SupplementalRemoveInfo theRemoveInfo) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  virtual
  void
  attributesInScope(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & theAttributes) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  virtual
  void
  attributesOutOfScope(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & theAttributes) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  // 6.18
  void provideAttributeValueUpdate(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & theAttributes,
                                           rti1516ev::VariableLengthData const & theUserSuppliedTag) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void turnUpdatesOnForObjectInstance(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & theAttributes) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void turnUpdatesOnForObjectInstance(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & theAttributes, std::wstring const & updateRateDesignator) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void turnUpdatesOffForObjectInstance(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & theAttributes) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void requestAttributeOwnershipAssumption(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & offeredAttributes,
                                           rti1516ev::VariableLengthData const & theUserSuppliedTag) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void requestDivestitureConfirmation(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & releasedAttributes) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void attributeOwnershipAcquisitionNotification(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & securedAttributes,
                                                 rti1516ev::VariableLengthData const & theUserSuppliedTag) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void attributeOwnershipUnavailable(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & theAttributes) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void requestAttributeOwnershipRelease(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandleSet const & candidateAttributes,
                                                rti1516ev::VariableLengthData const & theUserSuppliedTag) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void informAttributeOwnership(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandle theAttribute,
  ...
  void attributeIsNotOwned(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandle theAttribute) override
  {
    if (!ob_federateAmbassador)
      return;
  ...
  void attributeIsOwnedByRTI(rti1516ev::ObjectInstanceHandle theObject, rti1516ev::AttributeHandle theAttribute) override
  {
    if (!ob_federateAmbassador)
      return;
...
struct PyRTIambassadorObject {
  PyObject_HEAD
  std::unique_ptr<rti1516ev::RTIambassador> ob_value;
...
PyRTIambassador_connect(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "connect", 3, 3, &arg1, &arg2, &arg3))
    return 0;
  ...
  rti1516ev::CallbackModel theCallbackModel;
  if (callbackModelString == L"HLA_IMMEDIATE")
    theCallbackModel = rti1516ev::HLA_IMMEDIATE;
  else if (callbackModelString == L"HLA_EVOKED")
    theCallbackModel = rti1516ev::HLA_EVOKED;
  else
    theCallbackModel = rti1516ev::HLA_EVOKED;
...
PyRTIambassador_joinFederationExecution(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    ...
    if (logicaltimeFactoryName != L"HLAfloat64Time" && logicaltimeFactoryName != L"HLAinteger64Time") {
      self->ob_value->resignFederationExecution(rti1516ev::CANCEL_THEN_DELETE_THEN_DIVEST);
      self->_logicaltimeFactoryName.clear();
      throw rti1516ev::CouldNotCreateLogicalTimeFactory(logicaltimeFactoryName);
    }
...
static PyObject *
PyRTIambassador_unsubscribeObjectInstance(PyRTIambassadorObject *self, PyObject *args)
{
  PyObject *arg1 = 0;
  if (!PyArg_UnpackTuple(args, "unsubscribeObjectInstance", 1, 1, &arg1))
    return 0;

  rti1516ev::ObjectInstanceHandle objectInstanceHandle;
  ...
  try {
    ...
    self->ob_value->unsubscribeObjectInstance(objectInstanceHandle);
...
static PyObject *
PyRTIambassador_subscribeInteractionClassWithFilter(PyRTIambassadorObject *self, PyObject *args)
{
  PyObject *arg1 = 0, *arg2 = 0, *arg3 = 0;
  if (!PyArg_UnpackTuple(args, "subscribeInteractionClassAttributesWithFilter", 2, 3, &arg1, &arg2, &arg3))
    return 0;
  ...
  rti1516ev::ParameterHandleValueMap parameterHandleValueMap;
  ...
  try {
    ...
    self->ob_value->subscribeInteractionClassWithFilter(interactionClassHandle, parameterHandleValueMap, active);
...
PyRTIambassador_updateAttributeValues(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  rti1516ev::AttributeHandleValueMap attributeHandleValueMap;
  ...
  try {
    ...
    if (logicalTime.get()) {
      rti1516ev::MessageRetractionHandle messageRetractionHandle;
...
PyRTIambassador_attributeOwnershipDivestitureIfWanted(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    ...
    rti1516ev::AttributeHandleSet divestedAttributeHandleSet;
...
PyRTIambassador_enableTimeRegulation(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  std::unique_ptr<rti1516ev::LogicalTimeInterval> logicalTimeInterval;
...
PyRTIambassador_createRegion(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  rti1516ev::DimensionHandleSet dimensionHandleSet;
  ...
  try {
    ...
    rti1516ev::RegionHandle regionHandle;
...
PyRTIambassador_registerObjectInstanceWithRegions(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  rti1516ev::AttributeHandleSetRegionHandleSetPairVector attributeHandleSetRegionHandleSetPairVector;
...
PyRTIambassador_getFederateHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::FederateHandle federateHandle = self->ob_value->getFederateHandle(theName);
    return PyObject_NewFederateHandle(federateHandle);
  }
...
PyRTIambassador_getObjectClassHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::ObjectClassHandle objectClassHandle = self->ob_value->getObjectClassHandle(theName);
...
PyRTIambassador_getAttributeHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::AttributeHandle attributeHandle = self->ob_value->getAttributeHandle(objectClassHandle, theAttributeName);
...
PyRTIambassador_getInteractionClassHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::InteractionClassHandle interactionClassHandle = self->ob_value->getInteractionClassHandle(theName);
...
PyRTIambassador_getParameterHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::ParameterHandle parameterHandle = self->ob_value->getParameterHandle(interactionClassHandle, theParameterName);
...
PyRTIambassador_getObjectInstanceHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::ObjectInstanceHandle objectInstanceHandle = self->ob_value->getObjectInstanceHandle(theName);
    return PyObject_NewObjectInstanceHandle(objectInstanceHandle);
  }
  CATCH_C_EXCEPTION(ObjectInstanceNotKnown)
  CATCH_C_EXCEPTION(FederateNotExecutionMember)
...
PyRTIambassador_getDimensionHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::DimensionHandle dimensionHandle = self->ob_value->getDimensionHandle(theName);
...
PyRTIambassador_getDimensionName(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  rti1516ev::DimensionHandle dimensionHandle;
...
PyRTIambassador_getKnownObjectClassHandle(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::ObjectClassHandle objectClassHandle = self->ob_value->getKnownObjectClassHandle(objectInstanceHandle);
    return PyObject_NewObjectClassHandle(objectClassHandle);
  }
  CATCH_C_EXCEPTION(ObjectInstanceNotKnown)
  CATCH_C_EXCEPTION(FederateNotExecutionMember)
...
PyRTIambassador_getTransportationType(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::TransportationType transportationType = self->ob_value->getTransportationType(theName);
...
PyRTIambassador_getOrderType(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::OrderType transportationType = self->ob_value->getOrderType(theName);
...
PyRTIambassador_getOrderName(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  rti1516ev::OrderType transportationType;
...
PyRTIambassador_getRangeBounds(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  try {
    rti1516ev::RangeBounds rangeBounds = self->ob_value->getRangeBounds(regionHandle, dimensionHandle);
...
PyRTIambassador_setRangeBounds(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  rti1516ev::RangeBounds rangeBounds;
...
PyRTIambassador_normalizeServiceGroup(PyRTIambassadorObject *self, PyObject *args)
{
  ...
  rti1516ev::ServiceGroup serviceGroup;
...
{
  // The set of methods as found in the rti1516ev standard
  ...
  {"unsubscribeObjectInstance", (PyCFunction)PyRTIambassador_unsubscribeObjectInstance, METH_VARARGS, ""},
  {"unsubscribeObjectInstance", (PyCFunction)PyRTIambassador_unsubscribeObjectClassAttributes, METH_VARARGS, ""},
  {"subscribeInteractionClass", (PyCFunction)PyRTIambassador_subscribeInteractionClass, METH_VARARGS, ""},
  {"subscribeInteractionClassWithFilter", (PyCFunction)PyRTIambassador_subscribeInteractionClassWithFilter, METH_VARARGS, ""},
...
PyObject_NewRTIambassador(PyTypeObject *type, PyObject *args, PyObject * /*kwds*/)
{
  ...
  ambassador = rti1516ev::RTIambassadorFactory().createRTIambassador();
  if (!ambassador.get()) {
...
#define INITFUNCNAME CONCAT(PyInit_, PYMODULENAME)
...
INITFUNCNAME()
{
...
#else
  PyObject* module = Py_InitModule3("rti1516ev", rti1516e_methods, "rti1516ev RTI/HLA backend implementation.");
#endif
  ...
  // enum OrderType
  PyModule_AddIntConstant(module, "RECEIVE", rti1516ev::RECEIVE);
  PyModule_AddIntConstant(module, "TIMESTAMP", rti1516ev::TIMESTAMP);

  // enum ResignAction
  PyModule_AddIntConstant(module, "UNCONDITIONALLY_DIVEST_ATTRIBUTES", rti1516ev::UNCONDITIONALLY_DIVEST_ATTRIBUTES);
  PyModule_AddIntConstant(module, "DELETE_OBJECTS", rti1516ev::DELETE_OBJECTS);
  PyModule_AddIntConstant(module, "CANCEL_PENDING_OWNERSHIP_ACQUISITIONS", rti1516ev::CANCEL_PENDING_OWNERSHIP_ACQUISITIONS);
  PyModule_AddIntConstant(module, "DELETE_OBJECTS_THEN_DIVEST", rti1516ev::DELETE_OBJECTS_THEN_DIVEST);
  PyModule_AddIntConstant(module, "CANCEL_THEN_DELETE_THEN_DIVEST", rti1516ev::CANCEL_THEN_DELETE_THEN_DIVEST);
  PyModule_AddIntConstant(module, "NO_ACTION", rti1516ev::NO_ACTION);

  // enum RestoreFailureReason
  PyModule_AddIntConstant(module, "RTI_UNABLE_TO_RESTORE", rti1516ev::RTI_UNABLE_TO_RESTORE);
  PyModule_AddIntConstant(module, "FEDERATE_REPORTED_FAILURE_DURING_RESTORE", rti1516ev::FEDERATE_REPORTED_FAILURE_DURING_RESTORE);
  PyModule_AddIntConstant(module, "FEDERATE_RESIGNED_DURING_RESTORE", rti1516ev::FEDERATE_RESIGNED_DURING_RESTORE);
  PyModule_AddIntConstant(module, "RTI_DETECTED_FAILURE_DURING_RESTORE", rti1516ev::RTI_DETECTED_FAILURE_DURING_RESTORE);

  // enum RestoreStatus
  PyModule_AddIntConstant(module, "NO_RESTORE_IN_PROGRESS", rti1516ev::NO_RESTORE_IN_PROGRESS);
  PyModule_AddIntConstant(module, "FEDERATE_RESTORE_REQUEST_PENDING", rti1516ev::FEDERATE_RESTORE_REQUEST_PENDING);
  PyModule_AddIntConstant(module, "FEDERATE_WAITING_FOR_RESTORE_TO_BEGIN", rti1516ev::FEDERATE_WAITING_FOR_RESTORE_TO_BEGIN);
  PyModule_AddIntConstant(module, "FEDERATE_PREPARED_TO_RESTORE", rti1516ev::FEDERATE_PREPARED_TO_RESTORE);
  PyModule_AddIntConstant(module, "FEDERATE_RESTORING", rti1516ev::FEDERATE_RESTORING);
  PyModule_AddIntConstant(module, "FEDERATE_WAITING_FOR_FEDERATION_TO_RESTORE", rti1516ev::FEDERATE_WAITING_FOR_FEDERATION_TO_RESTORE);

  // enum SaveFailureReason
  PyModule_AddIntConstant(module, "RTI_UNABLE_TO_SAVE", rti1516ev::RTI_UNABLE_TO_SAVE);
  PyModule_AddIntConstant(module, "FEDERATE_REPORTED_FAILURE_DURING_SAVE", rti1516ev::FEDERATE_REPORTED_FAILURE_DURING_SAVE);
  PyModule_AddIntConstant(module, "FEDERATE_RESIGNED_DURING_SAVE", rti1516ev::FEDERATE_RESIGNED_DURING_SAVE);
  PyModule_AddIntConstant(module, "RTI_DETECTED_FAILURE_DURING_SAVE", rti1516ev::RTI_DETECTED_FAILURE_DURING_SAVE);
  PyModule_AddIntConstant(module, "SAVE_TIME_CANNOT_BE_HONORED", rti1516ev::SAVE_TIME_CANNOT_BE_HONORED);

  // enum SaveStatus
  PyModule_AddIntConstant(module, "NO_SAVE_IN_PROGRESS", rti1516ev::NO_SAVE_IN_PROGRESS);
  PyModule_AddIntConstant(module, "FEDERATE_INSTRUCTED_TO_SAVE", rti1516ev::FEDERATE_INSTRUCTED_TO_SAVE);
  PyModule_AddIntConstant(module, "FEDERATE_SAVING", rti1516ev::FEDERATE_SAVING);
  PyModule_AddIntConstant(module, "FEDERATE_WAITING_FOR_FEDERATION_TO_SAVE", rti1516ev::FEDERATE_WAITING_FOR_FEDERATION_TO_SAVE);

  // enum ServiceGroup
  PyModule_AddIntConstant(module, "FEDERATION_MANAGEMENT", rti1516ev::FEDERATION_MANAGEMENT);
  PyModule_AddIntConstant(module, "DECLARATION_MANAGEMENT", rti1516ev::DECLARATION_MANAGEMENT);
  PyModule_AddIntConstant(module, "OBJECT_MANAGEMENT", rti1516ev::OBJECT_MANAGEMENT);
  PyModule_AddIntConstant(module, "OWNERSHIP_MANAGEMENT", rti1516ev::OWNERSHIP_MANAGEMENT);
  PyModule_AddIntConstant(module, "TIME_MANAGEMENT", rti1516ev::TIME_MANAGEMENT);
  PyModule_AddIntConstant(module, "DATA_DISTRIBUTION_MANAGEMENT", rti1516ev::DATA_DISTRIBUTION_MANAGEMENT);
  PyModule_AddIntConstant(module, "SUPPORT_SERVICES", rti1516ev::SUPPORT_SERVICES);

  // enum SynchronizationFailureReason
  PyModule_AddIntConstant(module, "SYNCHRONIZATION_POINT_LABEL_NOT_UNIQUE", rti1516ev::SYNCHRONIZATION_POINT_LABEL_NOT_UNIQUE);
  PyModule_AddIntConstant(module, "SYNCHRONIZATION_SET_MEMBER_NOT_JOINED", rti1516ev::SYNCHRONIZATION_SET_MEMBER_NOT_JOINED);

  // enum TransportationType
  PyModule_AddIntConstant(module, "RELIABLE", rti1516ev::RELIABLE);
  PyModule_AddIntConstant(module, "BEST_EFFORT", rti1516ev::BEST_EFFORT);

  PyRTI1516EException.setBorrowedRef(PyErr_NewException((char*)"rti1516ev.Exception", NULL, NULL));
  PyModule_AddObject(module, "Exception", PyRTI1516EException.get());

#define RTI_EXCEPTION(ExceptionKind)                                                                            \
  PyRTI1516E ## ExceptionKind.setBorrowedRef(PyErr_NewException((char*)"rti1516ev." # ExceptionKind, PyRTI1516EException.get(), NULL)); \
